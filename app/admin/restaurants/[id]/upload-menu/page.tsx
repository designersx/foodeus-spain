...
//       "Descripción del Ítem": "Item_Description",
//     },
//   };
...
//     setFileName(file.name);
//     const reader = new FileReader();
//     console.log("File:", reader); // Debugging
...
//         const mapHeaders = headerMap[language];
        
//         const mappedHeaders = uploadedHeaders.map(h => mapHeaders[h.trim()] || h);
//         console.log("Map Headers:", mappedHeaders,uploadedHeaders,expectedHeaders); // Debugging
//         const isHeaderValid =
//           mappedHeaders.length === expectedHeaders.length &&
//           expectedHeaders.every((expected, index) => expected === mappedHeaders[index]);

//         if (!isHeaderValid) {
//           toast({
//             title: t("InvalidColumnsTitle"),
//             description: t("InvalidColumnsDesc").replace("{columns}", Object.keys(mapHeaders).join(", ")),
//             variant: "destructive",
//           });
//           return;
//         }
...
//       if (
//         mappedHeaders.includes("Menu_Name") &&
//         mappedHeaders.includes("Price") &&
//         mappedHeaders.includes("Category")
//       ) {
//         const rows = data.slice(1);
...
//     // Define columns
//     worksheet.columns = [
//       { header: t("SrNo"), key: "Sr_No", width: 10 },
//       { header: t("MenuName"), key: "Menu_Name", width: 20 },
//       { header: t("Price"), key: "Price", width: 15 },
//       { header: t("MenuDescription"), key: "Menu_Description", width: 30 },
//       { header: t("Category"), key: "Category", width: 20 },
//       { header: t("ItemName"), key: "Item_Name", width: 25 },
//       { header: t("ItemDescription"), key: "Item_Description", width: 40 },
//     ];
//     // Add sample rows
//     // const sampleData = [
//     //   [
