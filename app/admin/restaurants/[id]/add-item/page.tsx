...
export default function AddItemPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formDataToSubmit.append("menu_type", formData.menu_type);
    ...
    try {
      ...
      const response = await apiClient.post(`/restaurants/${restaurantId}/items/add`, formDataToSubmit, {
        headers: {
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                <Label>Item Image (click to upload)</Label>
                <div
